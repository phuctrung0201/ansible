    ...
    KeyNode {
        ...
        kind: KeyNodeKind::Group {
            ...
            nodes: &[
                ...
                KeyNode { key: 'x',  label: "close session",  kind: KeyNodeKind::Action(action::delete_session)  },
                KeyNode { key: 'c',  label: "clean up",       kind: KeyNodeKind::Action(action::session_cleanup) },
            ],
        },
    },
    KeyNode {
        ...
        kind: KeyNodeKind::Group {
            ...
            nodes: &[
                ...
                KeyNode { key: 'x',  label: "close pane",       kind: KeyNodeKind::Action(action::close_pane) },
            ],
        },
    },
    KeyNode {
